...
void loop()
{
  ...
  static float tiltx = 0.0;             //current tilt angle "x direction" probably actually z
  static float tilty = 0.0;             //current tilt angle y direction
  static float tiltz = 0.0;             //current tilt angle "z direction" probably actually x
  ...
  if (millis() > loopTimer) {
    ...
    tilty = a.acceleration.y/9.67;
    tiltz = a.acceleration.x/9.67;
